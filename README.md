# harmonious-building-manager

an internal app for. managing buiuldings and their characteristcs: 
...
```sh
git clone https://github.com/GPT-Engineer-App/harmonious-building-manager.git
cd harmonious-building-manager
npm i
```
